...
export default function InputInfo2({ info, title, keyProp }) {
  return (
    <div className="flex flex-col gap-2 md:px-6 py-2 px-3 border-b border-b-[#cecece] bg-[#f5f4f4]">
      ...
      {info && info.length > 0 ? (
        ...
        <p className="w-full md:w-1/2 h-auto text-start text-[#686868] font-normal text-base leading-6 bg-[#FBFBFB] border border-[#DCDBDB] rounded-lg px-4 py-2 md:py-1 outline-[#a8a8a8]">
          Sin especificar
        </p>
      )}
    </div>
