...
export default function InputExam({
  ...
  useEffect(() => {
    if (
      diagnostico?.physicalExaminations[
        diagnostico?.physicalExaminations?.length - 1
      ]?.physicalSubsystem
    ) {
      setSelectedOption(
        diagnostico?.physicalExaminations[
        ...
        <div className="flex flex-col items-center justify-center w-full px-4 py-4 bg-[#fafafc]">
          <div>
            <ButtonNext
              ...
              options={["Si", "No"]}
              name={"subsitemas"}
              handleSelection={handleSubsistemas}
          ...
          {selectedOption && (
            <div className="text-start text-[#686868] font-medium text-base leading-4 flex gap-2 w-full px-6 py-2">
          ...
          <div className="flex flex-col w-full gap-2 px-6 py-2 ">
            <textarea
              ...
              defaultValue={
                diagnostico?.physicalExaminations[0]?.description || ""
              }
            />
          </div>
        </div>
