      ...
      <details open={defaultOpen}>
        ...
        <div className="flex justify-start items-center gap-2 px-3 bg-[#fafafc] md:pr-10">
          ...
          <div className="flex justify-end w-1/2 gap-4">
            <button
              type="button"
              className={`px-4 py-3 border-2 rounded-lg border-[#DCDBDB] flex gap-2 ${glucemiaElevada === true ? "bg-greenPrimary text-white" : ""
                }`}
            ...
            <button
              type="button"
              className={`px-4 py-3 border-2 rounded-lg border-[#DCDBDB] flex gap-2 items-center ${glucemiaElevada === false ? "bg-[#ff0000] text-white" : ""
                }`}
          ...
          <div className="flex justify-between w-1/2 grid-cols-2 gap-1 md:flex md:gap-4 ">
            {ultimosValoresAnormales.map((value, index) => (
              <input
                key={index}
                type="text"
                className="md:px-4 text-center py-1 border-2 rounded-lg border-[#DCDBDB] w-full "
                defaultValue={value}
