...
const MenuDropDown = ({ icon, iconr, label, categories, items, className, classNameButton }) => {
  return (
    <Dropdown
      ...
      <DropdownTrigger className={`flex justify-center lg:px-4 font-Roboto font-bold py-2 text-white rounded-lg lg:gap-3 bg-[#487FFA] items-center cursor-pointer ${classNameButton}`}>
