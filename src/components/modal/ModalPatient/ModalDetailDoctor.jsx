          ...
          <div className="flex flex-col justify-around p-5 w-full h-full font-medium">
            <div className="flex items-center justify-between w-full px-5">
              <div className="w-full flex items-center justify-start gap-3">
                <IconCircle className="w-3" /> Nombre completo
              </div>
            ...
            <div className="flex items-center justify-between w-full px-5">
              <div className="w-full flex items-center justify-start gap-3">
                <IconCircle className="w-3" /> Especialidad
              </div>
              <span className="w-full flex justify-start">
            ...
            <div className="flex items-center justify-between w-full px-5">
              <div className="w-full flex items-center justify-start gap-3">
                <IconCircle className="w-3" /> Lugar de atención
              </div>
              <span className="w-full flex justify-start">
            ...
            <div className="flex items-center justify-between w-full px-5">
              <div className="w-full flex items-center justify-start gap-3">
                <IconCircle className="w-3" /> Numero de contacto
              </div>
