...
export default function ImportarHC({ onData, text, disabled, state }) {
  ...
  const handleTitleChange = (e) => {
    ...
    sendData([
      { study: studyBase, title: e.target.value, description, studyType },
    ]);
  };
  ...
  const handleDescriptionChange = (e) => {
    ...
    sendData([
      { study: studyBase, title, description: e.target.value, studyType },
    ]);
  };
  ...
  const handleStudyType = (name, value) => {
    ...
    if (selectedStudy) {
      ...
      sendData([
        { study: studyBase, title, description, studyType: selectedStudy.id },
      ]);
    }
  };
      ...
      <div className="gap-2 flex flex-col">
        <div className="flex flex-col gap-2">
          ...
          <DropNext
            ...
            selectedOptions={
              state?.CatStudyTypePatientStudies?.name ||
              state?.CatStudyType?.name
            }
          />
        </div>
        {!text && !disabled ? (
