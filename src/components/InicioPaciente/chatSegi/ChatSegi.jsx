...
export const ChatSegi = ({ toggleChat }) => {
  ...
  return (
    <div className="fixed z-50 h-[72%] max-h-[580px] lg:max-h-[600px] w-[90%] lg:h-[85%] lg:max-w-[600px] lg:w-[30%] bottom-[4%] right-[2%] border-bluePrimary bg-bluePrimary border overflow-hidden rounded-3xl">
