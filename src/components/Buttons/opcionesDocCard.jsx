...
export default function OpcionesDocCard({ onDetailClick, id, onConsultationClick }) {
    return (
        <details className="relative">
            ...
            <ul className="absolute bg-white z-50 p-5 w-64 right-0 border-2 border-[#D7D7D7] rounded-lg gap-4 mt-2 shadow-lg">
