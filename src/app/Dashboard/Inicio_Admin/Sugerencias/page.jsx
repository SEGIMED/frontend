...
export default function Sugerencias() {
    ...
    const [selectedSugerencia, setSelectedSugerencia] = useState();
                ...
                categories={[
                    {
                        items: [
                            ...
                            },
                            {
                                ...
                                onClick: () => { setSelectedSugerencia(row); setShowModal(true) }
                            },
                            {
                                label: "Eliminar ",
    ...
    return (
        <div className="h-full w-full"> <TableToolBar title={"Sugerencias"} showBackButton={true} />
            <DynamicTable
                columns={columns}
                ...
                textError={"No hay sugerencias"}
                loading={loading}
            />
            <ModalModularizado
                isOpen={showModal}
                onClose={() => { setShowModal(false); }}
                Modals={[<ModalSugerencia state={selectedSugerencia} disabled={true} key={"modalSugerencia"} />]}
