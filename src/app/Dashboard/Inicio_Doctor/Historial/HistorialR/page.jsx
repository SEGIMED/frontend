        ...
        <div className="h-full text-[#686868] w-full flex flex-col">
            ...
            <div className="flex flex-col items-start justify-center w-full">
                {scheduledConsultas?.map(paciente => (
                    <PatientCardConsulta key={paciente.id} paciente={paciente} button={<OptPteHistorial id={paciente.patient} ruta={`${rutas.Doctor}${rutas.Pacientes}${rutas.Historia_Clinica}/${paciente.patient}/${rutas.Consultas}`} />} />
                ))}
            </div>
        </div>
    );
