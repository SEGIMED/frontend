  ...
  return (
    <div className="h-full w-full flex flex-col">
      <div className="w-full flex justify-between px-5 items-center border-b bg-white border-b-[#cecece] pb-2 pt-2">
        <Ordenar />
        <p className="text-[#686868] font-semibold  hidden md:block text-xl md:text-base leading-6">
          Diagnostico
        </p>
        <FiltrarPacientes />
      </div>
      <div className="overflow-y-scroll flex flex-col h-full w-full">
        ...
        {isLoading ? (
          ...
          <NotFound text="No hay historial de diagnósticos y tratamiento." sizeText="w-[90%]" />
        ) : (
          <TableDiagnostico
