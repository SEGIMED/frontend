    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex items-center justify-between border-b border-b-[#cecece] pl-5 pr-6 py-2 bg-white sticky top-0 z-20 md:z-50">
                <div></div>
                <h1 className="font-bold">Solicitar interconsulta</h1>
                <button className="flex items-center px-6 py-2 bg-bluePrimary rounded-xl gap-3 text-white font-bold">
                    ...
                    {selectedSpecialtiesValue ? (
                        ...
                        >
                            {filteredDoctors?.map((item) => (
                                <DropdownItem key={item.id} value={item.id} textValue={`${item.name} ${item.lastname}`}>
            ...
            <div className="flex items-center justify-between border-b border-b-[#cecece] px-3 md:px-6 py-2">
                ...
                <div className="py-2 md:py-0 flex justify-evenly md:gap-3">
                    <BotonInterconsulta
                        label="Sí"
            ...
            <div className="w-full justify-center flex pt-4">
                <button onClick={handleSubmit(onSubmit)} className="flex items-center px-6 py-2 bg-bluePrimary rounded-xl gap-3 text-white font-bold">
                    Solicitar
                </button>
            </div>
        </div>
