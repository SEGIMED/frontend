    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex items-center justify-between border-b border-b-[#cecece] pl-5 pr-6 py-2 bg-white sticky top-0 z-50">
                {/* <Ordenar funcion={handleSortToggle} /> */}<div></div>
                ...
                <button
                    ...
                    onClick={() => { router.push(`${rutas.PacienteDash}${rutas.Alarm}/${myID}`) }}
                >
                    <IconAlarmBlue /> Crear Alarma
                </button>
            </div>
            <div className="grid grid-cols-6 items-center border-b border-b-[#cecece] pl-2 pr-6 py-2 bg-white sticky top-14 z-10">
