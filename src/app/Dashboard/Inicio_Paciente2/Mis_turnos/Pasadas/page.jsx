...
export default function MisTurnosPte() {
    ...
    return (
        <div className="h-full flex flex-col overflow-y-auto md:overflow-y-hidden">
            ...
            <div className="grid grid-cols-6 md:grid-cols-7 items-center border-b border-b-[#cecece] text-center md:text-start p-2 bg-white static md:sticky top-14 z-10 md:z-4">
                <div className="flex">
