...
export default function AuthSelect() {
    ...
    return (
        <div className="mx-auto h-screen flex justify-center items-center antialiased">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <fieldset className="px-8 pb-5">
                            <label className="w-full">
                                <p className="text-[#5F5F5F] pb-2 leading-3">Número de Identificación</p>
                                <input
                                    {...register("idNumber", {
                                ...
                                />
                                {errors.idNumber && <span className="text-[#fe4848] pb-2 leading-3 text-sm">{errors.idNumber.message}</span>}
                            </label>
                            <label className="w-full">
                                <p className="text-[#5F5F5F] pb-2 leading-3 pt-10">Número de celular</p>
                                <input
                                    {...register("cellphone", {
                                        required: "Este campo es obligatorio",
            ...
            <div className="md:w-1/2 h-full bg-gradient-to-br from-blue-400 via-blue-600 to-blue-400 items-center justify-center flex flex-col">
